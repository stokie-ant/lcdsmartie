 ...
 *
 *  $Source: /root/lcdsmartie-cvsbackup/lcdsmartie/_SSL/Attic/USetup.pas,v $
...
begin
  ...
  // check if dll for ssl are present!!!
  if not fileExists(percorso+'libeay32.dll') or
     not fileExists(percorso+'ssleay32.dll') then EmailSSLEdit.Enabled := False;
